...
class Config:
    ...
    __slots__ = ("token", "steam_api_key", "spam", "ban", "files", "dota_triggers")
    ...
    def __init__(self):
        ...
        # Steam API ключ для резолва vanity URL (опционально)
        # Получить можно здесь: https://steamcommunity.com/dev/apikey
